...
a1 = Patiend('Shiskino', 'Elabuga', 'Tatarstan', 'T231K31', ['88005557777'], ['Veselov', 'Daniil', 'Arturovich'])
print(a1)
p1 = Procedure('Осмотр', 'Сегодня', 'Кирилл', 250)
p2 = Procedure('Принятие', 'Завтра', 'Алексей', 550)
p3 = Procedure('Вырезание', 'Сегодня', 'Дмитрий', 850)
